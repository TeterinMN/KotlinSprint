...
fun main() {
    val omeletOneServing = listOf(2, 50, 15)
    print("Какое количество порций требуется? >> ")
    val userAnswer = readln().toInt()
    val newOmeletOneServing = omeletOneServing.map { it * userAnswer }
    println(
        "На $userAnswer порций вам понадобится: \nЯиц – ${newOmeletOneServing[0]} шт.; " +
                "\nМолока – ${newOmeletOneServing[1]} мл.; \nСливочного масла – ${newOmeletOneServing[2]} гр.;"
    )
}